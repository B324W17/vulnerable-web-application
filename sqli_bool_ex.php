	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		<div class="row">
			<ol class="breadcrumb">
				...
				<li class="active">Boolean-based SQLi</li>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					<div class="panel-heading">List of Boolean-based SQLi Exercises
