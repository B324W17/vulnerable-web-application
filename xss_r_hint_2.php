			...
			<div class="col-md-12">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						...
						<p><span class="glyphicon glyphicon-hand-right"></span>
							<b>Spoiler:</b> Try it with JavaScript input.</p>
						<p><span class="glyphicon glyphicon-hand-right"></span>
							<b>Elaboration:</b> The referrer is an HTTP header that tells the webserver wchich domain the request came from.</p>
